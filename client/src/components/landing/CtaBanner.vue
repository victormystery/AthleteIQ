<template>
  <section class="py-12 md:py-20 px-4 sm:px-6">
    <div class="max-w-5xl mx-auto">
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 to-primary-800 px-6 py-12 sm:px-8 sm:py-16 text-center shadow-2xl shadow-primary-200">
        <!-- Decorative circles -->
